  ...
  return (
    <div className="relative w-full h-96" style={{ perspective: "1000px" }}>
      ...
      >
        {/* --- FRONT SIDE --- */}
        <div
          className="absolute inset-0 w-full h-full bg-white/80 backdrop-blur-xl border-2 border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 flex flex-col"
          style={{
        ...
        >
          ...
          <div className="flex justify-end shrink-0 mb-2">
            <button
              ...
              className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${
                flashcard.isStarred
                  ? "bg-linear-to-br from-amber-400 to-yellow-500 text-white shadow-lg shadow-amber-500/30"
          ...
          <div className="flex-1 overflow-y-auto flex flex-col px-2 custom-scrollbar">
            <p className="text-lg font-semibold text-slate-900 text-center leading-relaxed my-auto">
              {flashcard.question}
            </p>
          </div>
        ...
        {/* --- BACK SIDE --- */}
        <div
          className="absolute inset-0 w-full h-full bg-linear-to-br from-emerald-500 to-teal-500 border-2 border-emerald-400/60 rounded-2xl shadow-xl shadow-emerald-500/30 p-6 flex flex-col"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
        ...
        >
          ...
          {/* Scrollable Content Area */}
          <div className="flex-1 overflow-y-auto flex flex-col px-2 custom-scrollbar">
            <p className="text-lg font-semibold text-white text-center leading-relaxed my-auto">
              {flashcard.answer}
            </p>
          </div>
