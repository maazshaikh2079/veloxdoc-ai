  ...
  const stats = [
    {
      ...
      value: dashboardData.overview.totalNumOfDocuments,
      icon: FileText,
    ...
    },
    {
      ...
      // value: dashboardData.overview.totalNumOfFlashcards,
      value: dashboardData.overview.totalNumOfFlashcardSets,
      icon: BookOpen,
    ...
    {
      label: "Total Quizzes",
      value: dashboardData.overview.totalNumOfQuizzes,
      icon: BrainCircuit,
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300">
